import { makeBuffer, makeUint8Array, clampInt16, clampInt32 } from "./utils.js"
...
export function contentLength(files) {
...
export function dataDescriptor(file, needsZip64) {
...
export function centralHeader(file, offset, zip64HeaderLength = 0) {
...
export function zip64ExtraField(file, offset, zip64HeaderLength) {
